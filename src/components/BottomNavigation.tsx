...
export default function BottomNavigation() {
  return (
    <div
      className="
           container mt-[100px] 
           fixed bottom-0 w-full  border-t-2 
           border-gray-300 h-10 justify-around  pt-[20px] pb-[60px]
           text-gray-500 bg-white flex sm:hidden md:hidden lg:hidden xl:hidden 2xl:hidden
        "
    >
      <div className="flex bg-red-400 ">
        <Link href="/">
          <BarChart3 size={20} className="justify-center mx-auto" />
          <h2>Home</h2>
        </Link>
      </div>
      <div className="">
      ...
      <div className="">
        <Link href="/teacher">
          <BookCheck size={20} className="mx-auto" />
          <h2>Teacher</h2>
        </Link>
      </div>
      <div className="">
        <Link href="requests">
          <ScrollText size={20} className="mx-auto" />
          <h2>Request</h2>
        </Link>
      </div>
    </div>
